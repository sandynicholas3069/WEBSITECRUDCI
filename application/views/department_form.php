    ...
    <div class="bg-gray-900 shadow-lg rounded-lg p-8 w-full max-w-3xl mx-auto">
        ...
        <form action="<?= base_url('department/store') ?>" method="post">
            <div class="mb-4">
                ...
                <input type="text" id="department_name" name="department_name" class="mt-1 block w-full p-2 border border-gray-700 bg-gray-700 text-orange-300 rounded-md focus:ring focus:ring-orange-500" required>
            </div>
            <div class="mt-6">
                <button type="submit" class="w-full px-4 py-2 bg-orange-600 text-white font-semibold rounded-md shadow-lg hover:bg-orange-700 focus:ring focus:ring-orange-500">Add Department</button>
            </div>
        </form>
    </div>
</body>
