    ...
    <div class="bg-gray-900 shadow-lg rounded-lg p-8 w-full max-w-3xl mx-auto">
        ...
        <form action="<?= base_url('employee/update' . $employee->id) ?>" method="post">
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" value="<?= $employee->name ?>" class="mt-1 block w-full p-2 border border-gray-700 bg-gray-700 text-orange-300 rounded-md focus:ring-orange-500" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="date" id="birth" name="birth" value="<?= $employee->birth ?>" class="mt-1 block w-full p-2 border border-gray-700 bg-gray-700 text-orange-300 rounded-md focus:ring-orange-500" required>
            </div>
            <div class="mb-4">
                <label for="location" class="block text-sm font-medium text-orange-300">Location</label>
                <input type="text" id="location" name="location" value="<?= $employee->location ?>" class="mt-1 block w-full p-2 border border-gray-700 bg-gray-700 text-orange-300 rounded-md focus:ring-orange-500" required>
            </div>
            <div class="mb-4">
                <label for="phone_number" class="block text-sm font-medium text-orange-300">Phone Number</label>
                <input type="text" id="phone_number" name="phone_number" value="<?= $employee->phone_number ?>" class="mt-1 block w-full p-2 border border-gray-700 bg-gray-700 text-orange-300 rounded-md focus:ring-orange-500" required>
            </div>
            <div class="mb-4">
                <label for="email" class="block text-sm font-medium text-orange-300">Email</label>
                <input type="email" id="email" name="email" value="<?= $employee->email ?>" class="mt-1 block w-full p-2 border border-gray-700 bg-gray-700 text-orange-300 rounded-md focus:ring-orange-500" required>
            </div>
            <div class="mb-4">
                <label for="position" class="block text-sm font-medium text-orange-300">Position</label>
                <input type="text" id="position" name="position" value="<?= $employee->position ?>" class="mt-1 block w-full p-2 border border-gray-700 bg-gray-700 text-orange-300 rounded-md focus:ring-orange-500" required>
            </div>
            <div class="mb-4">
                <label for="salary" class="block text-sm font-medium text-orange-300">Salary</label>
                <input type="number" id="salary" name="salary" value="<?= $employee->salary ?>" class="mt-1 block w-full p-2 border border-gray-700 bg-gray-700 text-orange-300 rounded-md focus:ring-orange-500" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mt-6">
                <button type="submit" class="w-full px-4 py-2 bg-orange-600 text-white font-semibold rounded-md shadow-lg hover:bg-orange-700 focus:ring-orange-500">Edit Employee</button>
            </div>
        </form>
    </div>
</body>
